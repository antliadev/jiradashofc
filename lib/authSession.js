/**
 * authSession.js - Sessões assinadas sem estado para fallback de autenticação serverless.
 */
...
function getSessionSecret() {
  ...
  if (passwordLoginAllowed()) return 'jiradash-develop-admin-test-session-secret-v1';
  return '';
}
