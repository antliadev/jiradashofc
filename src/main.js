...
import { initBusinessHelpTooltips, renderPageLoading } from './utils/ui-feedback.js';
import { initSelectLists } from './utils/select-list.js';
import { initMultiSelects } from './utils/multi-select.js';

initSelectLists();
initMultiSelects();
initBusinessHelpTooltips();
...
registerRoute('/projects/resource-allocation', () => renderRoute(() => import('./pages/resource-allocation.js'), 'renderResourceAllocation'));
registerRoute('/projects/sprint-plan', () => renderRoute(() => import('./pages/sprint-plan.js'), 'renderSprintPlan'));
